...
export const DATABASE = 'mongodb+srv://faruqsoft:faruqsoft101105@cluster0.jkdvl.mongodb.net/ecomweceAPI=Cluster0'
...
export const MAX_JASON_SIZE = "10MB"
export const URL_ENCODE = true

export const REQUEST_TIME = 20*60*1000
export const REQUEST_NUMBERE = 2000

export const STORE_ID = "xxxxx"
export const STORE_PASSWORD="xxxxxx"
